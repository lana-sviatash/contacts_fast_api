...
async def search_contacts_by_last_name(lastname: str, db: Session = Depends(get_db)):
...
async def search_contacts_by_first_name(firstname: str, db: Session = Depends(get_db)):
